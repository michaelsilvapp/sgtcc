...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sg TCC</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <form method="POST" action="<?php echo base_url('login/sair')?>">
                          <li><button name="btnsair" type="submit" class="btn btn-danger btn-block btn-flat"><span class="fa fa-fw fa-power-off"></span> Sair</button></li>
                        </form>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
